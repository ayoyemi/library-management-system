...
<body style="background-image: url('images/library2.jpg')">
    <div class="container"> 
        <div class="row text-center ">
            <div class="col-md-12">
                <br /><br />
                <h2 style="color: white"> Online Library Management System : Login</h2>
                  ...
                  <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                        ...
                        <strong>   Enter Details To Login </strong>  
                            ...
                            <div class="panel-body">
                                ...
                                <?php } ?>
                                <?php if(@$_SESSION['reg_msg']) { ?>
                                  <h6 class="text-center" style="color: #00cc00;"><?php echo $_SESSION['reg_msg']; ?></h6>
                                <?php } ?>
                                <form role="form" method="post" action="login_process.php" onsubmit="return validate();">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="pull-right">
                                            <a href="register.php" >New Member?<br>Register here </a> 
                                        </span>
                                    </div>
